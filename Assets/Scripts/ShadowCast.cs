...
- Uses a trivial "Vector2Int" class, which just holds a pair of integers.
...
namespace JuniperJackal
{
	public static class ShadowCast
	{
		...
		public static void ComputeVisibility(ICellGrid grid, Vector2Int gridPosn, float viewRadius)
		{
		...
		private static void CastLight(ICellGrid grid, Vector2Int gridPosn, float viewRadius,
